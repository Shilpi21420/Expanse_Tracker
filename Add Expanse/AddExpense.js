...
export default function AddExpense() {
  ...
  const submithandler = async (event) => {
    ...
    if (edit) {
      ...
      const response = await axios.put(
        `https://reac-expansetracker-default-rtdb.firebaseio.com/expenses/${id}.json`,
        details
      );
      ...
      const res = await axios.post(
        "https://reac-expansetracker-default-rtdb.firebaseio.com/expenses.json",
        details
      );
      // setpost(post+1);
  ...
  async function myfun() {
    const data = await axios.get(
      "https://reac-expansetracker-default-rtdb.firebaseio.com/expenses.json?print=pretty"
    );
